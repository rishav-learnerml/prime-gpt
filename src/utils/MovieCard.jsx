...
const MovieCard = ({
  ...
  console.log(description, "broo");

  return (
    <div
      onMouseOver={() => setShowInfo(true)}
      onMouseLeave={() => setShowInfo(false)}
      className={`z-1 transition-transform transform hover:scale-125 hover:zoom-in-150 ${
        showInfo && "z-40 relative mt-10"
      }`}
    >
      <div className="w-60 cursor-pointer relative">
        <img
          ...
          className={`rounded-lg ${
            !showInfo ? "rounded-t-lg" : "rounded-b-none"
          }`}
        />
      ...
      {showInfo && (
        <div className="px-5 py-5 shadow-sm z-50 bg-black w-60">
